...
export function CursorSpotlight() {
  ...
  return (
    <div
      ...
      style={{
        background:
          "radial-gradient(circle, oklch(0.82 0.18 200 / 0.18) 0%, oklch(0.7 0.25 310 / 0.08) 40%, transparent 70%)",
  ...
  return (
    <div className="fixed top-0 left-0 right-0 h-[2px] z-[60] pointer-events-none">
      <div
        ...
        style={{
          background:
            "linear-gradient(90deg, oklch(0.82 0.18 200), oklch(0.7 0.25 310), oklch(0.88 0.2 140))",
          transform: "scaleX(0)",
    ...
    >
      ...
      {glare && (
        <div
          ...
          style={{
            background:
              "radial-gradient(400px circle at var(--mx,50%) var(--my,50%), oklch(0.82 0.18 200 / 0.15), transparent 50%)",
          }}
        />
      )}
    </div>
...
export function CountUp({
  ...
  return (
    <span ref={ref} className={className}>
      {n.toString().padStart(String(to).length, "0")}
      {suffix}
    </span>
  );
}
